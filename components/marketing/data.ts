...
export const faqs = [
  {"question": "Kann ich mit MonDex Pokémon-Karten auf dem Handy scannen?", "answer": "Ja. Der aktuelle iOS-Entwicklungsbuild bietet Auto für fortlaufende Erkennung, Snap für einzelne Karten, Batch für mehrere Karten und Packs für eine Opening-Session. Unterstützte Kamera-Scans können mit einem zuvor geladenen Paket auch offline erkannt und später synchronisiert werden. Die Website selbst nutzt keine Kamera und zeigt nur Demos und Aufnahmen aus der App."},
  ...
  { question: "Wann erscheint MonDex?", answer: "MonDex ist in Entwicklung. Ein Veröffentlichungstermin steht noch nicht fest. Trag dich in die Warteliste ein, dann schreiben wir dir, sobald MonDex verfügbar ist." },
  { question: "Für welche Plattformen ist MonDex geplant?", answer: "MonDex wird für iPhone und Android entwickelt und startet zuerst auf dem iPhone. Welche Geräte und Betriebssystemversionen zum Launch unterstützt werden, steht noch nicht endgültig fest." },
  ...
  { question: "Sind die gezeigten Funktionen bereits verfügbar?", answer: "Die neuen Aufnahmen stammen aus dem aktuellen iOS-Entwicklungsbuild und die beschriebenen Funktionen sind im MonDex-Projekt implementiert. Die App ist trotzdem noch kein öffentlicher Download: Launch-Termin, endgültiger Funktionsumfang und unterstützte Geräte sind noch nicht bestätigt. Die interaktiven Website-Demos verwenden weiterhin nur Beispieldaten." },
];
