...
export const featureContent: Record<FeaturePath, Record<Locale, FeatureCopy>> = {
  "/pokemon-tcg-scanner": {
    en: {
      ...
      intro: "MonDex is a Pokémon TCG scanning and collection app launching on iPhone first, with Android in development. Its scanning workflow connects a photographed card to the things collectors care about: the right printing, a place in the collection and progress in a personal Pokédex.",
      ...
      sections: [
        ...
        { title: "One card, a stack or a pack opening", paragraphs: ["The current iOS build offers Snap for one card, Auto for continuous on-device recognition, Batch for several cards and Packs for keeping an opening session together. Supported camera scans can use a previously downloaded recognition pack while offline and sync saved results later.", "Recognition does not automatically mark a card as owned. The captured photo, suggested card and printing remain reviewable before you confirm the entry or deliberately enable automatic adding. The website demonstrates the visual scan reaction; it does not use your camera or identify a real card."] },
    ...
    de: {
      ...
      intro: "MonDex entsteht als Pokémon-TCG-Scanner und Sammlungs-App, die zuerst auf dem iPhone startet; Android wird entwickelt. Der Scan verbindet eine fotografierte Karte mit dem, was beim Sammeln zählt: der richtigen Variante, einem Platz in deiner Sammlung und Fortschritt im persönlichen Pokédex.",
      ...
      sections: [
        ...
        { title: "Eine Karte, einen Stapel oder ein Pack Opening erfassen", paragraphs: ["Der aktuelle iOS-Build bietet Snap für eine Karte, Auto für fortlaufende Erkennung direkt auf dem Gerät, Batch für mehrere Karten und Packs für eine zusammenhängende Opening-Session. Unterstützte Kamera-Scans können mit einem zuvor geladenen Erkennungspaket offline arbeiten und gespeicherte Ergebnisse später synchronisieren.", "Eine Erkennung markiert eine Karte nicht automatisch als Besitz. Foto, Kartenvorschlag und Druckvariante bleiben vor dem Bestätigen prüfbar — oder du aktivierst das automatische Hinzufügen bewusst. Die Website zeigt die visuelle Scan-Reaktion; sie verwendet keine Kamera und erkennt keine echten Karten."] },
