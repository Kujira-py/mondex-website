...
const copy: Record<Locale, LegalCopy> = {
  en: {
    ...
    title: 'Legal Notice',
    intro:
      'Who’s behind MonDex, how to reach us, and a few things to know about the prices, grades and Pokémon content you see in the app and on this site.',
    ...
    fields: {
      ...
      email: 'Email',
      phone: 'Phone',
      register: 'Company register / UID / VAT',
      responsible: 'Responsible for content',
    },
    sections: [
      {
        id: 'prices',
        title: 'Prices and grades',
        body: (
          <>
            <p>
              Card prices in MonDex are market estimates from third-party sources, provided for
              information only. They aren’t financial or investment advice, and they aren’t an offer
              to buy or sell.
            </p>
      ...
      },
      {
        ...
        body: (
          <p>
            External links take you to websites operated by others. Their own privacy information
            and terms apply there. Please let us know if you find a broken or problematic link.
          </p>
        ),
      },
      {
        ...
        body: (
          <p>
            The text and design of this website and the MonDex name and logo: ©{' '}
            <Fill>{COPYRIGHT_YEAR}</Fill> <Fill>{operator.name}</Fill>. Pokémon names and card
            images belong to their owners (see above).
          </p>
        ),
      },
      {
  ...
  de: {
    ...
    title: 'Impressum',
    intro:
      'Wer hinter MonDex steht, wie du uns erreichst, und was du über die Preise, Zustandsschätzungen und Pokémon-Inhalte in der App und auf dieser Website wissen solltest.',
    ...
    fields: {
      ...
      email: 'E-Mail',
      phone: 'Telefon',
      register: 'Handelsregister / UID / USt-IdNr.',
      responsible: 'Verantwortlich für den Inhalt',
    },
    sections: [
      {
        id: 'prices',
        title: 'Preise und Zustandsschätzungen',
        body: (
          <>
            <p>
              Kartenpreise in MonDex sind Marktschätzungen aus Quellen Dritter und dienen nur zur
              Information. Sie sind keine Finanz- oder Anlageberatung und kein Angebot zum Kauf oder
              Verkauf.
            </p>
      ...
      },
      {
        ...
        body: (
          <p>
            Externe Links führen zu Websites anderer Betreiber. Dort gelten deren eigene
            Datenschutzinformationen und Bedingungen. Bitte gib uns Bescheid, wenn du einen defekten
            oder problematischen Link findest.
          </p>
        ),
      },
      {
        ...
        body: (
          <p>
            Texte und Gestaltung dieser Website sowie Name und Logo von MonDex: ©{' '}
            <Fill>{COPYRIGHT_YEAR}</Fill> <Fill>{operator.name}</Fill>. Pokémon-Namen und
            Kartenbilder gehören ihren Inhabern (siehe oben).
          </p>
        ),
      },
      {
